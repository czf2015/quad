...
export const Text = ({ store }) => {
  ...
  return (
    <div className={styles.text_wrapper}>
      ...
      <div className={styles.flex}>
        <label><FontSizeOutlined /><Input value={store('fontSize')} onChange={setStore('fontSize')} defaultValue="12px" style={{ width: 71 }} min={0} size="small" controls={false} bordered={false} /></label>
        <label><LineHeightOutlined /><Input value={store('lineHeight')} onChange={setStore('lineHeight')} defaultValue="12px" style={{ width: 71 }} min={0} size="small" controls={false} bordered={false} /></label>
        <label><img src="/icons/WordSpacing.svg" width="16" height="16" /><Input value={store('wordSpacing')} onChange={setStore('wordSpacing')} defaultValue="0px" style={{ width: 71 }} min={0} size="small" controls={false} bordered={false} /></label>
      </div>
